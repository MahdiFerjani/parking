...
const char *ssid =  "airbox-F16E";     // Enter your WiFi Name
const char *pass =  "11615686"; // Enter your WiFi Password

#define MQTT_SERV "io.adafruit.com"
#define MQTT_PORT 1883
#define TOKEN               "25e0e270-4574-11eb-98a1-a35bba5c6a07"
...
void ICACHE_RAM_ATTR ISRoutine ();*/
  ...
  tb.sendTelemetryInt("Carsparked", Carsparked);
   tb.sendTelemetryInt("EntrySlot1",EntrySlot1 );
...
void setup() {
  ...
  pinMode(slot2, INPUT);
  pinMode(slot3, INPUT);
  WiFi.begin("Globalnet", "changeme");                                     //try to connect with wifi
